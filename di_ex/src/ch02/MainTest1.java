...
public class MainTest1 {
	...
	public static void main(String[] args) {
		...
		// 중간클래스 만들었음 
		String url = "www.navar.com/books/id?=100";
		
		// IEncoder 생성자 타입 -> 의존 주입 설계 
		// Base64Encoder <-- IEncoder 타입으로 바라볼 수있다 (다형성)
		// URLEncoder <-- IEncoder 타입으로 바라볼 수있다 (다형성)
...
//		
//		Encoder encoder3 = new Encoder(new Base64Encoder());
